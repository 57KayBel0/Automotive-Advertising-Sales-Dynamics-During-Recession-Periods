...
Original file is located at
    https://colab.research.google.com/drive/1D4_4I2evx6m8ss045Ssx56r1QZoUSfj2
...
# compute yearly average sales
df_line = df.groupby('Year')['Automobile_Sales'].mean()

# plot line and enable legend
df_line.plot(kind='line', label='Avg Automobile Sales')
...
# annotate two recession periods just above their data points
plt.text(1982, df_line.loc[1982] + 50, '1981–82 Recession')
plt.text(2009, df_line.loc[2009] + 50, '2008–09 Recession')
...
plt.title('Consumer_Confidence' and 'Automobile_Sales')
plt.show()

# Filter only recession periods
rec_data = df[df['Recession'] == 1]

# 1) Scatter: Average Vehicle Price vs Sales Volume during Recessions
plt.figure(figsize=(10, 6))
plt.scatter(
    rec_data['Price'],
...
# 2) Scatter: Consumer Confidence vs Automobile Sales during Recessions
plt.figure(figsize=(10, 6))
plt.scatter(
...
# Plot unemployment rate vs. sales volume by vehicle type
sns.lineplot(
    data=df_rec,
    x='unemployment_rate',
    y='Automobile_Sales',
